...
class MainActivity : AppCompatActivity(),
    ...
    fun ShowPicture() {
        /*
        when (PictureNo) {
            0 -> img.setImageResource(R.drawable.pp0)
            1 -> img.setImageResource(R.drawable.pp1)
            2 -> img.setImageResource(R.drawable.pp2)
            3 -> img.setImageResource(R.drawable.pp3)
            4 -> img.setImageResource(R.drawable.pp4)
            5 -> img.setImageResource(R.drawable.pp5)
        }
        */
        txv.text = PictureNo.toString()
        var res:Int = getResources().getIdentifier("pp" + PictureNo.toString(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        while (res != 0) {
            countDrawables++;
            res = getResources().getIdentifier("pp" + countDrawables.toString(),
                "drawable", getPackageName());
        }
